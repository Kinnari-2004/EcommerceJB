...
export class Migration1775211935126 implements MigrationInterface {
    name = 'Migration1775211935126'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "userId" integer NOT NULL, "placedAt" datetime NOT NULL DEFAULT (datetime('now')), "paymentMethod" varchar NOT NULL, "totalAmount" decimal(10,2) NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" text, "price" decimal(10,2) NOT NULL, "stock" integer NOT NULL DEFAULT (0), "imagePath" varchar, "subCategoryId" integer, "createdAt" datetime NOT NULL DEFAULT (datetime('now')))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "email" varchar NOT NULL, "passwordHash" varchar NOT NULL, "role" varchar NOT NULL DEFAULT ('customer'), "isLocked" boolean NOT NULL DEFAULT (0), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_order" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "userId" integer NOT NULL, "placedAt" datetime NOT NULL DEFAULT (datetime('now')), "paymentMethod" varchar NOT NULL, "totalAmount" decimal(10,2) NOT NULL, CONSTRAINT "FK_caabe91507b3379c7ba73637b84" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_order"("id", "userId", "placedAt", "paymentMethod", "totalAmount") SELECT "id", "userId", "placedAt", "paymentMethod", "totalAmount" FROM "order"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_product" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" text, "price" decimal(10,2) NOT NULL, "stock" integer NOT NULL DEFAULT (0), "imagePath" varchar, "subCategoryId" integer, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_463d24f6d4905c488bd509164e6" FOREIGN KEY ("subCategoryId") REFERENCES "sub_category" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "userId" integer NOT NULL, "placedAt" datetime NOT NULL DEFAULT (datetime('now')), "paymentMethod" varchar NOT NULL, "totalAmount" decimal(10,2) NOT NULL)`);
        await queryRunner.query(`INSERT INTO "order"("id", "userId", "placedAt", "paymentMethod", "totalAmount") SELECT "id", "userId", "placedAt", "paymentMethod", "totalAmount" FROM "temporary_order"`);
